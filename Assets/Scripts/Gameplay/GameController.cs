...
public class GameController : MonoBehaviour {
	...
	public void FirstStep(Ingredient ingredient) {		
		...
		ingredient.mySprite.gameObject.transform.position = LeftBottomSpawn.position;
		//ingredient.mySlider.maxValue = SpawnTime;
		//ingredient.Fill.color = Color.blue;
		ingredient.ItemsContainer.SetActive (true);
	...
	public void ShowActionHelp(Ingredient ingredient) {
		...
		string animationName = UppercaseFirst (ingredient.Interaction) + "Help";
		HelperLabel.gameObject.SetActive (true);
		HelperLabel.text = UppercaseFirst (ingredient.Interaction) + "!";
	...
	void SpawnIngredient (int ingredientIndex) {
		...
		float x = Random.Range (RightTopSpawn.position.x, RightTopSpawn.position.x);
		float y = Random.Range (RightTopSpawn.position.y, RightTopSpawn.position.y);
